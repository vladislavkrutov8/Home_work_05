...
welcome_text = ('Приветсвую вас и добро пожаловать в игру?\n'
                'Для начала я расскажу правила:\n'
                'Вам дается 2021 конфета, вы берете их поочереди,\n'
                'причем, за один раз можно взять не больше 28 конфет.\n'
                'Выигрывает тот, кто последним ходом заберет все конфеты.\n'
                )
print(welcome_text)

message = ['твоя очередь', 'бери еще', 'бери больше', 'маловато',
           'бери быстрее', 'мда уж, что то долго']
